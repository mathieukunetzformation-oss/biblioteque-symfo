 ...
 */
final class Version20260204104037 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, isbn_id VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, is_avaiable TINYINT NOT NULL, category_id INT DEFAULT NULL, INDEX IDX_CBE5A33112469DE2 (category_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, date_reservation DATE NOT NULL, date_expected_return DATE NOT NULL, book_id INT DEFAULT NULL, reserving_user_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_42C8495516A2B381 (book_id), INDEX IDX_42C849555E4EDE40 (reserving_user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
